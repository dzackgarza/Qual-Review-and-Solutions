...
- 5 roots:
  ...
  - $S_n$ is generated by $(a,b)$ and $(1,2,\cdots,n) \iff \gcd(b-a, n) = 1$.
    In particular, the transposition $(1, 2)$ works.
:::


:::{.fact}
Some useful generating sets:
...
- $G(x^4-2) = D_4$: 
  ...
  - $D_4 \leq S_4$ is the only transitive subgroup of order 8.
    - Explicitly, there is a 4-cycle $\sigma = (1,2,3,4)$ generated by $\omega \mapsto \zeta_4 \omega$ and a 2-cycle $(2,4)$ given by complex conjugation, and this is enough to generate $D_4$.
