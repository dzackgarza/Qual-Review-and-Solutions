...
- $G(x^4-2) = D_4$: 
  ...
  - $D_4 \leq S_4$ is the only transitive subgroup of order 8.
    - Explicitly, there is a 4-cycle $(1,2,3,4)$ generated by $\omega \mapsto \zeta_2 \omega$ and a 2-cycle $(1,3)$ given by complex conjugation, and this is enough to generate $D_4$.
