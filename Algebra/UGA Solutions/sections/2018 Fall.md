...
- Sylow $p\dash$subgroups are all conjugate, so if $S_p^j$ is any other Sylow $p\dash$subgroup, $gS_p^i g\inv = S_p^j$ for *some* $g\in G$.

- So $P = gPg\inv \subseteq gS_p^i g\inv = S_p^j$.
