...
- As in the construction of the Cantor set, let 
  ...
  - $K_1$ denote $[0, 1]$ with 1 interval $\intvl{ {4 \over 10}, {5 \over 10} }$ of length $1 \over 10$ deleted
  - $K_2$ denote $K_1$ with 9 intervals $\intvl{ {1 \over 100}, {5\over 100}], ~[{14 \over 100}, {15 \over 100}\intvl, \cdots [{94\over 100}, {95 \over 100}]$ length ${1 \over 100}$ deleted
