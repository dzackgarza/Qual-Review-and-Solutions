...
- Then break the integral up into integrals over periods $P_1, P_2, \cdots, P_N$ where $N = \floor{n/\pi}$:
\begin{align*}
...
&= N {2\over n} +  \int_{N\floor{\pi/n}}^1 \abs{\sin(nx)}\,dx \\
&\definedas \floor{\pi \over n} {2\over n} +  \int_{N\floor{\pi/n}}^1 \abs{\sin(nx)}\,dx
.\end{align*}
