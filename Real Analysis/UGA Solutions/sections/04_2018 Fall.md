...
- Claim: since $E$ is measurable, $E^c$ is measurable
  ...
  - Note that
  \begin{align*}
E^c\setminus S \definedas E\setminus \union_{n=1}^\infty \OO_n^c \definedas E^c \intersect \qty{\intersect_{n=1}^\infty \OO_n}^c = \qty{E \union \qty{\intersect_{n=1}^\infty \OO_n} }
  .\end{align*}
  - Then $m_*()$
