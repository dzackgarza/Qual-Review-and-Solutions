...
- Note that the slice $$E^t \definedas \theset{x\in \RR^n \suchthat (x, t) \in E} = \theset{x\in \RR^n \suchthat 0 \leq t < f(x)}$$ is precisely what appears in the RHS integrand.
- By the claim,
\begin{align*}
