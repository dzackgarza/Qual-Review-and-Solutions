...
- Claim: since $E$ is measurable, $E^c$ is measurable
  ...
  - Note that
  \begin{align*}
  E^c\setminus S &\definedas E^c \setminus \union_{n=1}^\infty \OO_n^c \definedas E^c \intersect \qty{\intersect_{n=1}^\infty \OO_n}^c = \qty{E^c \union \qty{\intersect_{n=1}^\infty \OO_n} } \definedas \qty{ \intersect_{n=1}^\infty \OO_n} \setminus E
  .\end{align*}
  - Then $m_*()$
