...
- The $f_n$ restricted to $(1, \infty)$ are uniformly bounded by $g_1(x) = {1\over x^{n-1}}$ on $[1, \infty)$, since
  \begin{align*}
x \in (1, \infty) \implies \frac{x}{1+x^n} \leq {x \over x^n} = {1 \over x^{n-1}}
  ,\end{align*}
