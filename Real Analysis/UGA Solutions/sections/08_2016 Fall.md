...
- Claim: $G\in \mcm$.
  ...
  - But $\mcm$ is a $\sigma\dash$algebra, and this exhibits $G$ as a countable union/of measurable sets, since $E_n\in \mcm$ for all $n$ implies that $E_n^c\in \mcm$ and $\mcm$ is a $\sigma\dash$algebra.
