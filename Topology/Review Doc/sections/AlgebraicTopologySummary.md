...
| $\RP^3$                       | $\pi_*K(\ZZ_2, 1)\times \pi_* S^3$             | $H_*M(\ZZ_2, 1) \times H_*M(\ZZ, 3)$                               | $1 + x + x^2 + x^3$                            | ${}_{0}\ZZ \times {}_{2}\ZZ_2 \times {}_{3}\ZZ$   |
| $\RP^4$                       | $\pi_*K(\ZZ_2, 1)\times \pi_* S^4$             | $H_*M(\ZZ_2, 1) \times H_*M(\ZZ_2, 3)$                             | $1 + x + x^2 + x^3 + x^4$                      | ${}_{0}\ZZ \times ({}_{2}\ZZ_2)^2$                |
