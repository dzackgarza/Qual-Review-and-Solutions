...
disconnection \(X = A{\coprod}B\) with \(A, B\) nonempty open sets. I.e.
\(X\) can not be written as the disjoint union of two proper nonempty
open sets. Equivalently, \(X\) contains no proper nonempty clopen sets.
...
\begin{align*}\left< \alpha, \beta \right> = [M] \frown ([\alpha] {}^{ \check{} }\smile [\beta] {}^{ \check{} })
.\end{align*}
...
\section{``Analysis''-esque Results in
...
\begin{proposition}[Existence of universal covers]
...
\begin{example}[Covering spaces of wedges of spheres]
...
\begin{example}[of a universal covering space]
...
\begin{proposition}[Application: showing one space can not cover another]
